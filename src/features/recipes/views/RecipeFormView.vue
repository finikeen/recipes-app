...
const handleSubmit = async () => {
  ...
  try {
    ...
    submitError.value =
      err.message || "An error occurred while saving the recipe.";
  } finally {
...
onMounted(async () => {
  ...
  try {
    ...
    ingredients.value = fetchedIngredients.map(
      ...
      <fieldset class="rform__section" aria-label="Ingredients">
        ...
        >
          ...
          <button
            ...
            @click="removeIngredient(ing._key)"
        ...
        >
          ...
          <div class="rform__direction-controls">
            ...
            <button
              type="button"
              class="forge__button rform__remove-btn"
              @click="removeDirection(dir._key)"
