...
The app's security rules allow anyone to read recipes but restrict writing (create, update, delete) to authenticated users who own the recipe. See [`docs/firestore-security-rules.md`](./firestore-security-rules.md) for the full rules and an explanation of each permission.
